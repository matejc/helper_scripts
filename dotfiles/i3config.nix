{ variables, config, pkgs, lib }:
{
  ...
  exec --no-startup-id /bin/sh -c "/run/current-system/sw/bin/feh --bg-fill /home/matejc/Pictures/kde-wallpapers/df16bc4b.jpg; /run/current-system/sw/bin/i3-msg restart"
